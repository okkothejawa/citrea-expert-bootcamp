...
contract BitcoinMinerIncentivesTest is Test {
    ...
    function testIncentive() public {
        ...
        bytes memory output0 = BTCUtils.extractOutputAtIndex(vout, 0);
        bytes memory scriptHash = BTCUtils.extractHash(output0);
        bytes memory btcScript = CheckBitcoinSigs.p2wpkhFromPubkey(minerPubkey);
